...
const {
  test,
  society_signup,
  getRegisteredSocieties,
  society_login,
  getProfile,
  generateOtp,
  checkOtp,
  resetPassword,
} = require("../../controllers/society/society.controller");
const {
  createApplication,
  updateApplication,
  getApplicationBySocietyId,
} = require("../../controllers/society/application/application.society.controller");
const {
  requireSocietyAuth,
} = require("../../middlewares/societies.middleware");
const {
  getApplicationById,
